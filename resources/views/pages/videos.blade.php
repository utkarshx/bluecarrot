        ...
        <div class="container" style="padding-top: 20px;">
            ...
            <div class="col-md-8">
                <div class="panel panel-default">
                    <div class="embed-responsive embed-responsive-16by9">
                        <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/DHI1jMfiEk4" frameborder="0" allowfullscreen></iframe>
                    </div>
                </div>
                <div class="panel panel-default">
                    <div class="panel-body" id="actpan" style="padding-bottom: 0">
                        <div class="actions pull-right">
                            <div class="btn btn-default btn-xs"><i class="fa fa-thumbs-up"></i> 300</div>
                            <div class="btn btn-default btn-xs"><i class="fa fa-thumbs-down"></i> 300</div>
                            <a class="btn btn-info btn-xs" href="http://www.facebook.com/sharer/sharer.php?u=http%3A%2F%2Fwww.edflock.com&title=Edflock" target="_blank"><i class="fa fa-facebook"></i> Share</a>
                    ...
                    <div class="panel-body" style="padding-bottom: 0">
                        ...
                        <span class="tagSingle">
                            <span class="btn btn-default btn-xs">Game Color</span><span class="btn btn-default btn-xs">Game Color</span><span class="btn btn-default btn-xs">Game Color</span><span class="btn btn-default btn-xs">Game Color</span><span class="btn btn-default btn-xs">Game Color</span>
                        </span>
            ...
            <div class="col-md-4">
                <div class="panel panel-primary">
                    @include('includes.widgets.tagcloudbtn')
                </div>
                <div class="panel panel-primary">
                    @include('includes.widgets.relatedvideos')
                </div>
            </div>
            <div class="clearfix"></div>
